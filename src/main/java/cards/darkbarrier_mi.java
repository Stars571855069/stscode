...
public class darkbarrier_mi extends CustomCard
{
    public static final String ID = "mi_darkbarrier";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom((AbstractGameAction)new GainBlockAction((AbstractCreature)p, (AbstractCreature)p,BLOCK_AMT));
    }

    @Override
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard)new darkbarrier_mi();
    }
