...
public class shadow_amulet_mi extends CustomCard
{
    public static final String ID = "mi_shadow_amulet";
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard)new shadow_amulet_mi();
    }
